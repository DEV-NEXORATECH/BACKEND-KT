...
class CustomerInvoice extends Model
{
    ...
    protected $fillable = ['invoice_number', 'customer_id', 'project_id', 'donor_id', 'program_id', 'invoice_date', 'due_date', 'currency_code', 'exchange_rate', 'status', 'total_amount', 'received_amount', 'description', 'journal_id', 'posted_at', 'posted_by', 'created_by', 'updated_by', 'deleted_by'];
