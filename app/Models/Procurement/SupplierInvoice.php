...
class SupplierInvoice extends Model
{
    ...
    protected $fillable = ['purchase_order_id', 'goods_receipt_id', 'vendor_id', 'tax_id', 'invoice_number', 'invoice_date', 'due_date', 'status', 'match_status', 'total_amount', 'paid_amount', 'notes', 'attachments', 'journal_id', 'posted_at', 'posted_by', 'created_by', 'updated_by', 'deleted_by'];
