    ...
    public function run(): void
    {
        ...
        $menuDefinitions = [
            ...
            ['title' => 'Expenses & Approvals', 'slug' => 'expenses-approvals', 'path' => '/expenses-approvals', 'icon' => 'wallet', 'sort_order' => 30, 'children' => [
                ...
                ['title' => 'Finance Verification', 'slug' => 'finance-verification', 'path' => '/expenses-approvals/expenses', 'sort_order' => 35],
                ['title' => 'Payment Processing', 'slug' => 'payment-processing', 'path' => '/expenses-approvals/expenses', 'sort_order' => 36],
                ['title' => 'Expense Monitoring', 'slug' => 'expense-monitoring', 'path' => '/expenses-approvals/expenses', 'sort_order' => 37],
            ...
            ['title' => 'Accounting', 'slug' => 'accounting', 'path' => '/accounting', 'icon' => 'accounting', 'sort_order' => 40, 'children' => [
                ...
                ['title' => 'Period Closing', 'slug' => 'period-closing', 'path' => '/master-data/accounting-periods', 'sort_order' => 46],
